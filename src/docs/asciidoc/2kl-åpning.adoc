...
2 [black]#♣# apningen er normalt sterkere enn i Nordisk Standard.
Med balanserte hender er det 22hp+.

Ingen antall poeng med ubalanserte hender. Men god spillestyrke!

Vi åpner 2 [black]#♣# når vi har så spillesterk hånd at vi ikke klarer tanken på at andre meldinger blir passet.
...
| 2 [red]#♦#
| Hvilemelding. Hvis neste melding er 3 [black]#♣#, eller steget over makkers melding er det 0-4
